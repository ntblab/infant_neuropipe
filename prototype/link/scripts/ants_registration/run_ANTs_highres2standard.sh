...
echo fsleyes $ants_dir/example_func2standard.nii.gz $manual_reg $adult_standard $ants_dir/highres2standard.nii.gz
...
fsleyes $ants_dir/example_func2standard.nii.gz $manual_reg $adult_standard $ants_dir/highres2standard.nii.gz 
