#!/usr/bin/sh
#
# Take in a volume name (representing data stored in a group standard folder) and number of TRs to add a movies worth of data (93 TRs for MM, corresponding to 90 task TRs and a default of 3 burn-in TRs) to both the functional volume and to the confound regressor
source ./globals.sh
